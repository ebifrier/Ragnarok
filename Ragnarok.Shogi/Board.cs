...
namespace Ragnarok.Shogi
{
    ...
    public partial class Board
    {
        ...
        /// 打ち歩詰のチェックを行います。
        /// </summary>
        public bool IsPawnDropCheckMate(Colour colour, Square square)
        {
#if OUTE_SHOGI
            // 王手将棋では打ち歩詰めを反則にしません。
            return false;
        ...
        public bool Validate()
        {
            ...
            // 玉の数をカウントします。
            if (GetKingCount(Colour.Black) > 1 ||
                GetKingCount(Colour.White) > 1)
            {
                return false;
            }
