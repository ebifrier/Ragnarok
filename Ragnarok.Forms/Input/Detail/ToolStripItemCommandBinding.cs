...
namespace Ragnarok.Forms.Input.Detail
{
    ...
    /// </summary>
    internal sealed class ToolStripItemCommandBinding : CommandBindingBase
    {
        private ToolStripItem target;

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public ToolStripItemCommandBinding(ToolStripItem target, ICommand command,
