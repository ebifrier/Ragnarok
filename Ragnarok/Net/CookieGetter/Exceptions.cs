...
namespace Ragnarok.Net.CookieGetter
{
	...
	public class CookieGetterException : Exception
	{
        ...
        public CookieGetterException(string message)
            : base(message)
        {
        }
        ...
        public CookieGetterException(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        protected CookieGetterException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
	}
