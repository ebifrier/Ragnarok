...
namespace Ragnarok.NicoNico.Live
{
    ...
    public static class StrUtil
    {
        ...
        /// </summary>
        public static Live.ProviderType ToProvider(string value)
        {
            if (string.IsNullOrEmpty(value))
            {
                return Live.ProviderType.Unknown;
            }

            if (value == "community")
            {
                return Live.ProviderType.Community;
            }
            else if (value == "channel")
            {
                return Live.ProviderType.Channel;
            }
            else if (value == "official")
            {
                return Live.ProviderType.Official;
            }
