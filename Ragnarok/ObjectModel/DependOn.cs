...
namespace Ragnarok.ObjectModel
{
    ...
    public class DependOnAttribute : Attribute
    {
        ...
        {
            var other = obj as DependOnAttribute;
            if (other == null)
            {
                return false;
            }
        ...
        /// コンストラクタ
        /// </summary>
        public DependOnAttribute(Type dependType, string dependName)
        {
        ...
        /// コンストラクタ
        /// </summary>
        public DependOnAttribute(Type dependType)
        {
            this.DependType = dependType;
        ...
        /// コンストラクタ
        /// </summary>
        public DependOnAttribute(string dependName)
        {
            this.DependName = dependName;
        }
    }
