...
namespace live2d
{
	namespace framework
	{
		class PriorityMotionQueueManager : public MotionQueueManager
		{
			typedef MotionQueueManager super;
		public:
            PriorityMotionQueueManager();
            virtual ~PriorityMotionQueueManager(){}
		...
		public:
			...
			//  モーション開始
			int startMotionPriority( live2d::AMotion* motion, bool isDelete, int priority );
